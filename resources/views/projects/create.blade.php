    ...
    <div class="body-div px-4 py-1 mb-3">
        <div class="body-head">
            <div class="body-h6 mb-3">
                <h6 class="head1h6"><a href="./dashboard.php">Dashboard /</a></h6>
                <h6 class="head1h6"><a href="./list_project.php">My Projects /</a></h6>
                <h6 class="head2h6"><a href="./add_project.php">Add Project</a></h6>
            </div>
        </div>
        ...
        <form action="{{ route('project.store') }}" method="post" onsubmit="return validateForm()" id="project_create"
            ...
            <div class="form-div pt-0">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6 col-xl-6 mb-3 inputs">
                        ...
                        <input type="text" class="form-control" name="project_id" id="project_id" required>
                    ...
                    <div class="col-sm-12 col-md-4 col-xl-4 mb-3 inputs">
                        ...
                        <input type="number" class="form-control" name="contact_number" id="contact_number"
                            oninput="validate_contact(this)" min="6" required>
                    ...
                    <!-- <div class="col-sm-12 col-md-4 col-xl-4 mb-3 inputs">
                                                                ...
                                                                <input type="number" class="form-control" name="alternate_contact_number"
                                                                    id="alternate_contact_number" oninput="validate_contact(this)" min="6">
                    ...
                    <div class="col-sm-12 col-md-4 col-xl-4 mb-3 inputs">
                        ...
                        <textarea rows="1" class="form-control" name="client_address" id="client_address" required></textarea>
                    ...
                    <div class="col-sm-12 col-md-4 col-xl-4 mb-3 inputs">
                        ...
                        <input type="text" class="form-control" name="client_state" id="client_state" required>
                    ...
                    <div class="col-sm-12 col-md-4 col-xl-4 mb-3 inputs">
                        ...
                        <input type="number" class="form-control" name="client_pincode" id="client_pincode"
                            oninput="validate_pin(this)" min="000000" max="999999" required>
                    ...
                    <div class="col-sm-12 col-md-12 col-xl-12 mb-3 inputs">
                        ...
                        <textarea rows="1" class="form-control" name="pro_address" id="prjt_address" required></textarea>
                        <small class="text-danger" id="address-error"></small>
                    </div>
                    <div class="col-sm-12 col-md-4 col-xl-4 mb-3 inputs">
                        <label for="prjt_city">City</label>
                        <input type="text" class="form-control" name="pro_city" id="prjt_city" required>
                        <small class="text-danger" id="city-error"></small>
                    </div>
                    <div class="col-sm-12 col-md-4 col-xl-4 mb-3 inputs">
                        <label for="prjt_state">State</label>
                        <input type="text" class="form-control" name="pro_state" id="prjt_state" required>
                        <small class="text-danger" id="state-error"></small>
                    </div>
                    <div class="col-sm-12 col-md-4 col-xl-4 mb-3 inputs">
                    ...
                    <div class="col-sm-12 col-md-6 col-xl-6 mb-3 inputs">
                        ...
                        <div class="inpflex">
                            <input type="text" class="form-control border-0" name="plot_size" id="plot_size"
                                required>
                            <select class="form-select border-0 inpselect" name="plot_unit" id="plot_unit">
                                <option>sq.ft</option>
                            </select>
                        </div>
                    ...
                    <div class="col-sm-12 col-md-6 col-xl-6 mb-3 inputs">
                        ...
                        <div class="inpflex">
                            ...
                            <select class="form-select border-0 inpselect" name="building_area_unit"
                                id="building_area_unit" required>
                                <option>sqft</option>
                            </select>
                        </div>
                    ...
                    <div class="col-sm-12 col-md-12 col-xl-12 mb-3 px-2 inputs">
                        <label class="custom-file-upload w-100 shadow-none" for="file_upload">
                            ...
                            <div class="text">
                                <span id="file-text" class="text-center">Choose a file (JPEG, PNG, PDF, and MP4 formats,
                                    upto 50MB)</span>
                            </div>
                                    ...
                                    <ul class="dropdown-menu w-100 px-2" id="roleDropdownMenu">
                                        @foreach ($employees as $employee)
                                            ...
                                            <div class="d-flex align-items-center w-100 mt-1">
                                                <input type="checkbox" class="me-2 checkbox" name="assigned_to[]"
                                                    value="{{ $employee->id }}">
            ...
            <div class="d-flex justify-content-center align-items-center mt-3">
                <button type="submit1" class="formbtn" onclick="validateForm();">Add Project</button>
            </div>
        </form>
