                ...
                <div class="listtable">
                    <div class="filter-container row">
                        ...
                        <div class="filter-container-end">
                            <button class="listbtn" data-bs-toggle="modal" data-bs-target="#addunit"><i
                                    class="fas fa-plus pe-2"></i>Create Unit</button>
                        </div>
                    </div>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                @if($data->status == "active")
                                                    <a href="{{url('uom-status-update/' . $data->id . '/inactive')}}">
                                                        <i class="fas fa-circle-xmark text-danger" data-bs-toggle="tooltip"
                                                            data-bs-title="Inactive"></i>
                                                    </a>
                                                @else
                                                    <a href="{{url('uom-status-update/' . $data->id . '/active')}}">
                                                ...
                                                <i class="fas fa-pen-to-square edit_button" data-bs-toggle="modal"
                                                    ...
                                                    data_description="{{$data->description}}" data-bs-target="#editunit"></i>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4 class="modal-title mb-2 fs-5" id="addunitLabel">Create Unit</h4>
                    <form action="{{route('settings.uomstore')}}" method="post">
                        @csrf
    ...
    <div class="modal fade" id="editunit" tabindex="-1" aria-labelledby="editunitLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4 class="modal-title mb-2 fs-5" id="editunitLabel">Edit Unit</h4>
                    <form action="{{route('settings.uomstore')}}" method="post">
                        @csrf
                        <input type="hidden" name="id" id="edit_id">
                        <div class="col-sm-12 col-md-12 mb-1">
                            <label for="edit_name" class="col-form-label">Unit</label>
